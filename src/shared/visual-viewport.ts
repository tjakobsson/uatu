// Shared visible-viewport observation. iOS overlays
...
// visible region. The touch terminal sizes its panel from these events;
// the desktop shell also reads width and scale in its coalesced measurement.
//
