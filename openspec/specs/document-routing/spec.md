...
## Purpose
Route documents, commit previews, cross-document links, and fragments through the SPA with accurate URLs and browser history while preserving native handling for external and binary links.
## Requirements
