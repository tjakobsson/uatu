...
Define how the sidebar brand logo is rendered and the hover-only blink easter egg behavior, including accessibility and reduced-motion handling. The logo is decorative chrome — the easter egg is undocumented in user-facing materials.
