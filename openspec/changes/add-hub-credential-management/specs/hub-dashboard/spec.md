...
#### Scenario: Assigned but unusable credential is not treated as missing
...
- **AND** the existing backend startup validation reports the unusable assigned credential
