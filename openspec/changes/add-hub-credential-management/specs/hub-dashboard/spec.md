...
Removing an assignment from a running workspace SHALL warn that stopping terminates its shells. Confirming SHALL stop the workspace before removing the assignment; cancelling or a failed stop SHALL leave the assignment unchanged.
