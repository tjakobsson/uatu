...
- [ ] 6.2 Run the targeted Hub navigation suite in Chromium and the installed Microsoft Edge channel, then manually verify the installed Edge PWA's navigation and history behavior. Deliver browser-specific evidence; record unavailable browser/PWA checks as blockers rather than marking them verified through emulation.
