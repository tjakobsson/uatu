...
- [x] 3.3 Run a real-device acceptance pass in iPhone and iPad Safari, checking the permission callout, successful paste, exactly-once input, and that the software keyboard/focus does not collapse; record the result in this change.
  - Findings (2026-08-07, uatu hub over Tailscale HTTPS): Safari on an iPhone 13 Pro running iOS 26.6 and on an iPad both showed the permission callout, pasted successfully exactly once, and retained terminal focus and the software keyboard.
