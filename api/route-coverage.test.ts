...
test("workspace route table and fallback routes are classified", async () => {
  ...
  for (const path of ["/api/state", "/api/document", "/api/document/diff", "/api/events", "/api/search", "/api/chat/status", "/api/chat/models", "/api/chat/commands", "/api/chat/conversations", "/api/chat/conversations/events", "/api/chat/conversations/{conversationId}", "/api/chat/conversations/{conversationId}/events", "/api/chat/conversations/{conversationId}/prompts", "/api/chat/conversations/{conversationId}/cancel", "/api/chat/conversations/{conversationId}/permissions/{interactionId}", "/api/chat/conversations/{conversationId}/questions/{interactionId}", "/api/auth", "/api/terminal", "/api/terminal/sessions", "/api/terminal/sessions/{terminalSessionId}"]) {
